        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span>{dict.common?.back || "Accueil"}</span>
            </Link>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-12">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-tight">
            {dict.contact?.title || "Nous Contacter"}
          </h1>

          <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
            {dict.contact?.subtitle || "Une question sur vos modèles de CV, votre pack VIP, un partenariat B2B ou un besoin d'assistance ? L'équipe INNOVA GROUP est à votre entière disposition."}
          </p>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[10px] font-black uppercase tracking-widest text-blue-400 block">
                    {dict.footer?.developedBy || "Éditeur & Développeur"}
                  </span>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={dict.contact?.namePlaceholder || "Ex: Amadou Diallo"}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={dict.contact?.emailPlaceholder || "nom@exemple.com"}
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50/50"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={dict.contact?.messagePlaceholder || "Expliquez-nous précisément comment nous pouvons vous aider..."}
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50/50"
                  />
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex items-center justify-center gap-5 text-xs font-semibold">
            <Link href="/terms" className="text-slate-600 hover:text-blue-600 transition-colors">
              {dict.nav?.termsOfUse || "Conditions d'Utilisation"}
            </Link>
            <Link href="/" className="text-blue-600 font-bold hover:underline">
              {dict.hero?.ctaCreateCv || "Créer un CV"} →
            </Link>
          </div>
        </div>
      </footer>
